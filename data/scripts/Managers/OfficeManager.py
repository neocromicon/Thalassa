...
class OfficeManager:
    ...
    def get_office_by_island(self, island_id):
        """Sucht das Kontor für eine bestimmte Insel-ID und gibt es zurück."""
        for building in self.buildings:
            if building["type"] == "office" and building["island_id"] == island_id:
                return building  # ✅ Gibt das Kontor als Dictionary zurück
        
        return None  # Falls kein Kontor auf dieser Insel existiert
